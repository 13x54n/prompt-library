...
export function StatsCards({
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={cn(
          "flex flex-wrap items-center justify-center gap-6 sm:gap-4 md:gap-0 px-4 py-20",
          inter.className,
          className
        )}
      >
        ...
        >
          <div>
            <h2 className="text-green-500 text-5xl font-semibold tracking-tighter">
              $100k+
            </h2>
          </div>
          <div>
            <h4 className="text-green-500 font-medium text-lg leading-tight tracking-tighter">
              Revenue driven
            </h4>
            <div className="w-full h-px bg-green-500 my-2"></div>
            <p className="text-green-500 text-sm leading-tight tracking-tight max-w-[90%]">
        ...
        <m.div
          className={cn(
            `relative z-30 ${width} ${height} bg-green-500 rounded-[16px] p-5 flex flex-col justify-between  flex-shrink-0 hover:z-50`
          )}
          initial={{
            rotate: 8,
          }}
