...
export const smoothDrawerVariants = {
  hidden: {
    y: "100%",
    opacity: 0,
    rotateX: 5,
...
export const smoothDrawerItemVariants = {
  hidden: {
    y: 20,
    opacity: 0,
    transition: {
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="mx-auto max-w-fit rounded-2xl p-6 shadow-xl">
        ...
        >
          <motion.div variants={smoothDrawerItemVariants}>
            <DrawerHeader className="space-y-2.5 px-0">
              <DrawerTitle className="flex items-center gap-2.5 font-semibold text-2xl tracking-tighter">
                ...
                <motion.span variants={smoothDrawerItemVariants}>
                  {title}
                </motion.span>
              </DrawerTitle>
              <motion.div variants={smoothDrawerItemVariants}>
